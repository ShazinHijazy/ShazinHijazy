...
<img src="https://img.shields.io/badge/LinkedIn-Shazin%20Hijazy-0A66C2?style=for-the-badge&logo=linkedin" />
</a>
...
<img src="https://img.shields.io/badge/Academia.edu-Profile-41454A?style=for-the-badge&logo=academia&logoColor=white" />
</a>
...
[![Open Source Research Reproducibility](https://img.shields.io/badge/Open%20Source%20Research%20Reproducibility-B45309?style=for-the-badge)](#open-source-research-reproducibility)
...
# 03. Role-Partitioned Swarm Intelligence
...
## Conference / Published Research

### Arbitration Layer for Decision-Making in Autonomous Underwater Robots

**Mohamed Hijazy Shazin Hassan, Neeraj S. M., Giri Rajasekhar Gunnu**

Presented at:

**8th International Conference on Ship and Offshore Technology (ICSOT 2025)**

Accepted for publication in Springer conference proceedings.

Research area:

`Autonomous Underwater Robotics · Decision-Making · Marine Robotics · Uncertainty-Aware Autonomy`

---

# Manuscripts and Ongoing Research
...
`UAV Swarms · Resilient Coordination · Communication-Aware Autonomy · Multi-Agent Control`
...
`Swarm Intelligence · Distributed Coordination · Role Partitioning · Resilient Robotics`
...
`Reliable AI · Calibration · Distribution Shift · Computer Vision`
...
`Machine Learning Theory · Calibration · Representation Learning · Reliable AI`
...
ROS 2 based autonomous surface vehicle platform integrating:
...
```mermaid
flowchart TD
    A["THEORY"] --> B["ALGORITHM"]
    B --> C["SOFTWARE MODEL"]
    C --> D["SIMULATION"]
    D --> E["SITL / GAZEBO"]
    E --> F["PERFORMANCE EVALUATION"]
    F --> G["HARDWARE INTEGRATION"]
    G --> H["REAL-WORLD ROBOT"]
```
...
Evaluate uncertainty, operational constraints, mission objectives, and available resources.
...
Across different robotic domains, my research repeatedly returns to one central problem:
...
<td width="50%" height="55" align="center" valign="middle">
...
<!-- ========================================================== -->
<!-- ROW 03 : INSTITUTION LOGOS -->
<!-- ========================================================== -->

<tr width="100%">

<td width="50%" height="80" align="center" valign="middle">
...
<td width="50%" height="60" align="center" valign="middle">

**Research Guide** <br>
</em>***Generalizable Robot Manipulation (PGDM)***</em>
...
**Research & Technical Guide**<br>
</em>***ADMOS · Arbitration***</em>
...
flowchart TB
    ...
    A["B.TECH THESIS <br/>
    UAV SWARMS"]
    B["RESEARCH DEVELOPMENT <br/>
    AI + ROBOTICS"]
    C["APPLIED RESEARCH <br/>
    MARINE + AI/ML"]
    D["MARINE ROBOTICS <br/>
    AUTONOMOUS CATAMARAN"]
